...
panel_D(1,1) = axes('position', [ 8.5  9.5 5 4]);
panel_D(1,2) = axes('position', [ 9   11.5 3 2]);
panel_D(2,1) = axes('position', [15    9.5 5 4]);
panel_D(2,2) = axes('position', [15.5 11.5 3 2]);
panel_E(1)   = axes('position', [ 8.5 4   5 4]);
panel_E(2)   = axes('position', [15   4   5 4]);
panel_legend = axes('position', [0.5 11.5 0.5 2]);
...
%     h.YScale = 'log';
    ...
    if ii_N == 1
        ...
        text(1.15,1.1, 'Mean decoding errors', 'Units','normalized','FontWeight','bold','HorizontalAlignment','center','FontSize',10);
    end
...
%     h.YScale = 'log';
    ...
    if ii_N == 1
        ...
        text(1.15,1.1, 'Catastrophic errors', 'Units','normalized','FontWeight','bold','HorizontalAlignment','center','FontSize',10);
    end
