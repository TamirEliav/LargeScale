...
%% load cell/exp data
cell = cell_load_data(cell_ID,'details','FE','FR_map','Ipos','fields','RecStability','spikes','signif','meanFR');
...
stats_table_data =  {...
    ...
    'map signif',       double(cell.signif(1).TF),          double(cell.signif(2).TF), [], '';...
    '',                [], [], [], '';...
    
    'num fields',       length(cell.fields{1}), length(cell.fields{2}), [], '';...
    'Largest',          max([cell.fields{1}.width_prc]), max([cell.fields{2}.width_prc]), max([cell.fields{1}.width_prc cell.fields{2}.width_prc]), 'm';...
    'Smallest',         min([cell.fields{1}.width_prc]), min([cell.fields{2}.width_prc]), min([cell.fields{1}.width_prc cell.fields{2}.width_prc]), 'm';...
    'ratio L/S',        max([cell.fields{1}.width_prc])/min([cell.fields{1}.width_prc]),...    
                        max([cell.fields{2}.width_prc])/min([cell.fields{2}.width_prc]),...
                        max([cell.fields{1}.width_prc cell.fields{2}.width_prc])/min([cell.fields{1}.width_prc cell.fields{2}.width_prc]),'';...
    'CV field size',    std([cell.fields{1}.width_prc])/mean([cell.fields{1}.width_prc]), ...    
                        ...
                        std([cell.fields{1}.width_prc cell.fields{2}.width_prc])/mean([cell.fields{1}.width_prc cell.fields{2}.width_prc]), '';...
	'',                [], [], [],'';...
	'Iso Dist.',        cell.spikes.Isolation_dis, [], [], '';...
    'L-Ratio.',         cell.spikes.L_Ratio, [], [], '';...
    'meanFR all',       cell.meanFR.all_sessions, [], [], 'Hz';...
    'meanFR air',       cell.meanFR.in_flight, [], [], 'Hz';...
                        
                        
};
columnname =   {'Parameter', 'dir1', 'dir2', 'dir1+2', 'units'};
