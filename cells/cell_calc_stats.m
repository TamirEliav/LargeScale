...
%     stats_per_dir(ii_dir).corr_all_full  = FR_map(ii_dir).corr_all_full.rho;
    ...
    switch length(fields_valid_speed)
        ...
        otherwise % #fields>=2
            ...
            stats_per_dir(ii_dir).field_smallest_vel3 = min([fields_valid_speed.vel3]);
            ...
            stats_per_dir(ii_dir).field_ratio_LS_vel3 = stats_per_dir(ii_dir).field_largest_vel3 / stats_per_dir(ii_dir).field_smallest_vel3;
    end
...
switch length(fields_valid_speed)
    ...
    otherwise % #fields>=2
        ...
        stats_all.field_largest_vel3  = fields_valid_speed(L_IX).vel3;
        stats_all.field_smallest_vel  = fields_valid_speed(S_IX).vel;
        stats_all.field_smallest_vel2 = fields_valid_speed(S_IX).vel2;
        stats_all.field_smallest_vel3 = fields_valid_speed(S_IX).vel3;
        ...
        stats_all.field_ratio_LS_vel3 = stats_all.field_largest_vel3 / stats_all.field_smallest_vel3;
