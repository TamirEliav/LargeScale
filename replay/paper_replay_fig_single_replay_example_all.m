...
%%
% TODO: move this list into an excel table
% TODO: get the event quantification struct for each of the events
examples_list = [
% sleep
...
struct('exp_ID','b0184_d191130', 'epoch_type','sleep', 'event_num',139), % good
...
struct('exp_ID','b0184_d191130', 'epoch_type','sleep', 'event_num',226), % good
...
struct('exp_ID','b0184_d191202', 'epoch_type','sleep', 'event_num',231), % good
...
struct('exp_ID','b0184_d191204', 'epoch_type','sleep', 'event_num',45), % good
...
struct('exp_ID','b0184_d191212', 'epoch_type','sleep', 'event_num',56), % good
...
struct('exp_ID','b2382_d190729', 'epoch_type','sleep', 'event_num',67), % good
...
struct('exp_ID','b2382_d190807', 'epoch_type','sleep', 'event_num',28), % good
...
struct('exp_ID','b9861_d180526', 'epoch_type','sleep', 'event_num',49), % good
struct('exp_ID','b0194_d180614', 'epoch_type','sleep', 'event_num',2),
struct('exp_ID','b0194_d180614', 'epoch_type','sleep', 'event_num',3),
struct('exp_ID','b0194_d180606', 'epoch_type','sleep', 'event_num',1), % good
...
struct('exp_ID','b0148_d170628', 'epoch_type','sleep', 'event_num',11), % good
...
%%
parfor ii_example = 1:length(examples_list)
