...
exp_path.decoding_spikes_detection = fullfile('L:\Analysis\pre_proc', batNum_str, date_str, 'decoding_spikes_detection');
...
exp_path.LFP_bands = fullfile('L:\Analysis\pre_proc', batNum_str, date_str, 'LFP_bands');
