function decode = decoding_load_data(exp_ID, epoch_type, params_opt, opts)
arguments
...
decode = decoding_read_decoded_file(decode_filename,'load_likelihood',opts.load_likelihood);
